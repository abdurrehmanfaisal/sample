  ...
  if(!empty($_POST['username']) && !empty($_POST['password'])) {
    ...
    if($response = mysqli_query($conn,$login_sql)) {
      ...
      if($password == $password_db) {
        ...
        $_SESSION['name'] = test_input($user['name']);
        $_SESSION['email'] = test_input($user['email']);
        $_SESSION['dob'] = test_input($user['dob']);
        ...
        switch($_SESSION['roleid']) {
          ...
          break;
           case 2:
            header('LOCATION:./lawyer/lawyer.dashboard.php');
            exit();
          break;
          case 3:
...
<head>
  ...
  <title>Login - Lawyer Management System</title>
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form accept="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100" type="submit" name="submitBtn">Login</button>
                    </div>
                    <div class="col-12">
